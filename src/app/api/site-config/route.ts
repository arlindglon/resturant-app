...
export async function GET() {
  const [
    ...
    getSetting(SETTING_KEYS.TERMS_LINK_ENABLED),
    getSetting(SETTING_KEYS.PRIVACY_LINK_ENABLED),
    getSetting(SETTING_KEYS.DATADEL_LINK_ENABLED),
  ...
  return ok(
    {
      ...
      legalLinks: {
        terms: termsLink !== 'false',
        privacy: privacyLink !== 'false',
        dataDel: datadelLink !== 'false',
      },
      geoFence: {
