...
export const SETTING_KEYS = {
  ...
  MESSENGER_QUICK_REPLIES_JSON: 'messenger_quick_replies_json', // প্রতিটা উত্তরের নিচের কুইক-রিপ্লাই বাটন (admin-সম্পাদনযোগ্য, 📸 স্ক্রিনশট-ফরম্যাট) — JSON [{title,payload}]; ফাঁকা = ডিফল্ট ৫ বাটন
...
export const SETTING_DEFAULTS: Record<string, string> = {
  ...
  [SETTING_KEYS.MESSENGER_QUICK_REPLIES_JSON]: '',
