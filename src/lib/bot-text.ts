...
const bn: Pack = {
  ...
  // ── static AI-fail answers: AI বন্ধ থাকলেও কাস্টমার সঠিক তথ্যই পায় —
  // কখনো "সমস্যা হচ্ছে" জাতীয় মেসেজ যায় না (bot-static.ts ব্যবহার করে) ──
  staticOffersHead: '🎁 *এই মুহূর্তে চলমান অফারসমূহ:*',
  staticOccasionLine: '{emoji} *{name}* — ৳{discount} ছাড় (ন্যূনতম বিল ৳{min})',
  staticVoucherLine: '🎟️ কুপন `{code}` — {title}: {disc} ছাড়{min}',
  staticMinBill: ' (ন্যূনতম অর্ডার ৳{min})',
  staticHappyLine: '🔥 {name}: {percent}% ছাড় — {start}–{end}',
  staticOfferHowTo: 'অফার নিতে রেস্তোরাঁর *বিল পেজ* থেকে "🎉 Claim on Messenger" চাপুন; কুপন হলে অর্ডারের সময় কোডটি ব্যবহার করুন।',
  staticNoOffers: 'এই মুহূর্তে চলমান কোনো অফার নেই — নতুন অফার সবার আগে পেতে পেজটি ফলো করে রাখুন!',
  staticMenuHead: '🍽️ *আজকের মেনু (জনপ্রিয় আইটেম):*',
  staticMoreMenu: '…সম্পূর্ণ মেনু দেখতে ও অর্ডার দিতে রেস্তোরাঁর টেবিলে QR স্ক্যান করুন।',
  staticGreetBack: 'আসসালামু আলাইকুম! 😊 আমি আছি — মেনু, দাম, অফার বা যেকোনো খোঁজখবরে সবসময় পাশে।',
  staticBye: 'আপনার আসার অপেক্ষায়! 😊 আরও কিছু জানতে চাইলে লিখুন।',
  staticLocationHead: '📍 আমাদের লোকেশন / ঠিকানা:',
  staticHelplineHead: '☎️ যোগাযোগ ও হেল্পলাইন:',
  staticInfoMissing: 'এই মুহূর্তে এই তথ্যটি যোগ করা হয়নি — নিচের বাটন থেকে মেনু বা অফার দেখে নিন! 👇',
...
const banglish: Pack = {
  ...
  staticOffersHead: '🎁 *Ei muhurte choloman offer gulo:*',
  staticOccasionLine: '{emoji} *{name}* — ৳{discount} discount (minimum bill ৳{min})',
  staticVoucherLine: '🎟️ Coupon `{code}` — {title}: {disc} discount{min}',
  staticMinBill: ' (minimum order ৳{min})',
  staticHappyLine: '🔥 {name}: {percent}% discount — {start}–{end}',
  staticOfferHowTo: 'Offer nite restaurant er *bill page* theke "🎉 Claim on Messenger" chapun; coupon hole order er somoy code ta use korun.',
  staticNoOffers: 'Ei muhurte kono offer cholche na — notun offer sobar age pete page ta follow kore rakhun!',
  staticMenuHead: '🍽️ *Ajker menu (popular item):*',
  staticMoreMenu: '…full menu dekhte o order dite restaurant er table e QR scan korun.',
  staticGreetBack: 'Assalamu alaikum! 😊 Ami achi — menu, dam, offer ba jekono khobjkhobor e sobshomoy pashi.',
  staticBye: 'Apnar ashar opekkhay! 😊 Aro kichhu jante chaile likhun.',
  staticLocationHead: '📍 Amader location / address:',
  staticHelplineHead: '☎️ Jogajog o helpline:',
  staticInfoMissing: 'Ei muhurte ei info ta jog kora hoy nai — nichher button theke menu ba offer dekhe nin! 👇',
...
const en: Pack = {
  ...
  staticOffersHead: '🎁 *Current offers right now:*',
  staticOccasionLine: '{emoji} *{name}* — ৳{discount} off (minimum bill ৳{min})',
  staticVoucherLine: '🎟️ Coupon `{code}` — {title}: {disc} off{min}',
  staticMinBill: ' (minimum order ৳{min})',
  staticHappyLine: '🔥 {name}: {percent}% off — {start}–{end}',
  staticOfferHowTo: 'To claim an offer tap "🎉 Claim on Messenger" on our *bill page*; for coupons use the code at checkout.',
  staticNoOffers: 'No offers are running right now — follow our page to catch new offers first!',
  staticMenuHead: '🍽️ *Today\'s menu (popular items):*',
  staticMoreMenu: '…scan the QR on your restaurant table for the full menu and to order.',
  staticGreetBack: 'Hello! 😊 We\'re here — menu, prices, offers or anything else, just ask anytime.',
  staticBye: 'Waiting for you! 😊 Text us anytime for anything else.',
  staticLocationHead: '📍 Our location / address:',
  staticHelplineHead: '☎️ Contact & helpline:',
  staticInfoMissing: "This info hasn't been added yet — check the menu or offers from the buttons below! 👇",
...
const hi: Pack = {
  ...
  staticOffersHead: '🎁 *इस समय चल रहे ऑफ़र:*',
  staticOccasionLine: '{emoji} *{name}* — ৳{discount} छूट (न्यूनतम बिल ৳{min})',
  staticVoucherLine: '🎟️ कूपन `{code}` — {title}: {disc} छूट{min}',
  staticMinBill: ' (न्यूनतम ऑर्डर ৳{min})',
  staticHappyLine: '🔥 {name}: {percent}% छूट — {start}–{end}',
  staticOfferHowTo: 'ऑफ़र पाने के लिए रेस्टोरेंट के *बिल पेज* पर "🎉 Claim on Messenger" दबाएं; कूपन हो तो ऑर्डर के समय कोड इस्तेमाल करें।',
  staticNoOffers: 'इस समय कोई ऑफ़र चल नहीं रहा — नए ऑफ़र सबसे पहले पाने के लिए पेज फॉलो करें!',
  staticMenuHead: '🍽️ *आज का मेनू (लोकप्रिय आइटम):*',
  staticMoreMenu: '…पूरा मेनू देखने और ऑर्डर देने के लिए रेस्टोरेंट की मेज़ पर QR स्कैन करें।',
  staticGreetBack: 'नमस्ते! 😊 हम हाज़िर हैं — मेनू, क़ीमत, ऑफ़र या कोई भी जानकारी, कभी भी पूछें।',
  staticBye: 'आपके इंतज़ार में! 😊 कुछ और जानना हो तो लिखें।',
  staticLocationHead: '📍 हमारी लोकेशन / पता:',
  staticHelplineHead: '☎️ संपर्क और हेल्पलाइन:',
  staticInfoMissing: 'यह जानकारी अभी जोड़ी नहीं गई है — नीचे के बटन से मेनू या ऑफ़र देखें! 👇',
